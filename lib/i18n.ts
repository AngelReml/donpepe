...
export interface Textos {
  ...
  /** "Déjanos tu reseña en Google": deja claro ANTES de tocar a dónde va el enlace. */
...
export const TEXTOS: Record<Idioma, Textos> = {
  es: {
    ...
    resenasSubtitulo: "Dos líneas nos ayudan mucho.",
    resenasGoogle: "Déjanos tu reseña en Google",
  ...
  gl: {
    ...
    resenasSubtitulo: "Dúas liñas axúdannos moito.",
    resenasGoogle: "Déixanos a túa reseña en Google",
  ...
  en: {
    ...
    resenasSubtitulo: "A couple of lines means a lot to us.",
    resenasGoogle: "Leave us a review on Google",
  ...
  pt: {
    ...
    resenasSubtitulo: "Duas linhas já nos ajudam muito.",
    resenasGoogle: "Deixe-nos a sua avaliação no Google",
    especialidadArroces: "Especialidade da casa",
  ...
  de: {
    ...
    resenasSubtitulo: "Schon ein paar Zeilen helfen uns sehr.",
    resenasGoogle: "Hinterlass uns eine Bewertung bei Google",
  ...
  fr: {
    ...
    resenasSubtitulo: "Quelques lignes nous aident beaucoup.",
    resenasGoogle: "Laissez-nous un avis sur Google",
  ...
  it: {
    ...
    resenasSubtitulo: "Anche solo due righe ci aiutano molto.",
    resenasGoogle: "Lasciaci una recensione su Google",
  ...
  ca: {
    ...
    resenasSubtitulo: "Dues línies ja ens ajuden molt.",
    resenasGoogle: "Deixa'ns la teva ressenya a Google",
  ...
  eu: {
    ...
    resenasSubtitulo: "Bi lerrok asko laguntzen digute.",
    resenasGoogle: "Utzi zure iritzia Google-n",
  ...
  nl: {
    ...
    resenasSubtitulo: "Een paar regels helpen ons al enorm.",
    resenasGoogle: "Laat een review achter op Google",
  ...
  pl: {
    ...
    resenasSubtitulo: "Kilka słów bardzo nam pomaga.",
    resenasGoogle: "Zostaw nam opinię w Google",
  ...
  cs: {
    ...
    resenasSubtitulo: "Pár řádků nám hodně pomůže.",
    resenasGoogle: "Nechte nám recenzi na Googlu",
  ...
  hu: {
    ...
    resenasSubtitulo: "Néhány sor is sokat segít.",
    resenasGoogle: "Írj nekünk értékelést a Google-on",
  ...
  ko: {
    ...
    resenasTitulo: "어떠셨나요?",
    resenasSubtitulo: "몇 줄이면 저희에게 큰 힘이 됩니다.",
    resenasGoogle: "구글에 리뷰를 남겨주세요",
  ...
  ja: {
    ...
    resenasSubtitulo: "二言、三言でも十分助かります。",
    resenasGoogle: "Googleでレビューを残してください",
  ...
  zh: {
    ...
    descubreLocal: "了解餐厅",
    resenasTitulo: "感觉如何？",
    resenasSubtitulo: "只需两行字就能帮我们大忙。",
    resenasGoogle: "请在谷歌上给我们留下评价",
  ...
  ru: {
    ...
    resenasSubtitulo: "Пара строк — и вы нам очень поможете.",
    resenasGoogle: "Оставьте нам отзыв в Google",
  ...
  ro: {
    ...
    resenasSubtitulo: "Câteva rânduri ne ajută foarte mult.",
    resenasGoogle: "Lasă-ne o recenzie pe Google",
